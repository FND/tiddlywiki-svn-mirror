...
adaptor.prototype.getWorkspaceListX = function(context, userParams, callback) {
	context = this.setContext(context, userParams, callback);
	context.workspaces = [];
	var uriTemplate = "%0/recipes"; // XXX: bags?
	var uri = uriTemplate.format([context.host]);
	console.log('gwlX',uri);
...
adaptor.prototype.getWorkspaceList = function(context, userParams, callback) {
	...
	var recipes = new window.tiddlyweb.Collection("recipes", context.host);
...
adaptor.prototype.getTiddlerListN = function(context, userParams, callback) {
	context = this.setContext(context, userParams, callback);
	var common2 = function(xhr) {
		context.statusText = xhr.statusText;
		context.httpStatus = xhr.status;
	...
	var recipe = new tiddlyweb.Recipe(context.workspace, context.host);
