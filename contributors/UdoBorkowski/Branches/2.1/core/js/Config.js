...
config.shadowTiddlers = {
	ColorPalette: "Background: #fff\n" + 
				  ...
				  "TertiaryDark: #666\n",
	StyleSheet: "",
	StyleSheetColors: "/***\n!Colors Used\n*@@bgcolor([[ColorPalette##PrimaryPale]]): [[ColorPalette##PrimaryPale]] - Background blue@@\n*@@bgcolor([[ColorPalette##PrimaryLight]]): [[ColorPalette##PrimaryLight]] - Top blue@@\n*@@bgcolor([[ColorPalette##PrimaryMid]]): [[ColorPalette##PrimaryMid]] - Mid blue@@\n*@@bgcolor([[ColorPalette##PrimaryDark]]):color([[ColorPalette##Background]]): [[ColorPalette##PrimaryDark]] - Bottom blue@@\n*@@bgcolor([[ColorPalette##SecondaryPale]]): [[ColorPalette##SecondaryPale]] - Bright yellow@@\n*@@bgcolor([[ColorPalette##SecondaryLight]]): [[ColorPalette##SecondaryLight]] - Highlight yellow@@\n*@@bgcolor([[ColorPalette##SecondaryMid]]): [[ColorPalette##SecondaryMid]] - Background yellow@@\n*@@bgcolor([[ColorPalette##SecondaryDark]]): [[ColorPalette##SecondaryDark]] - Border yellow@@\n*@@bgcolor([[ColorPalette##SecondaryDark]]):color([[ColorPalette##Background]]): [[ColorPalette##SecondaryDark]] - Title red@@\n*@@bgcolor([[ColorPalette##TertiaryDark]]): [[ColorPalette##TertiaryDark]] - Subtitle grey@@\n!Generic Rules /%==============================================%/\n***/\n/*{{{*/\nbody {\n	background: [[ColorPalette##Background]];\n	color: [[ColorPalette##Foreground]];\n}\n\na{\n	color: [[ColorPalette##PrimaryMid]];\n}\n\na:hover{\n	background: [[ColorPalette##PrimaryMid]];\n	color: [[ColorPalette##Background]];\n}\n\na img{\n	border: 0;\n}\n\nh1,h2,h3,h4,h5 {\n	color: [[ColorPalette##SecondaryDark]];\n	background: [[ColorPalette##PrimaryPale]];\n}\n\n.button {\n	color: [[ColorPalette##PrimaryDark]];\n	border: 1px solid [[ColorPalette##Background]];\n}\n\n.button:hover {\n	color: [[ColorPalette##PrimaryDark]];\n	background: [[ColorPalette##SecondaryLight]];\n	border-color: [[ColorPalette##SecondaryMid]];\n}\n\n.button:active {\n	color: [[ColorPalette##Background]];\n	background: [[ColorPalette##SecondaryMid]];\n	border: 1px solid [[ColorPalette##SecondaryDark]];\n}\n\n/*}}}*/\n/***\n!Header /%==================================================%/\n***/\n/*{{{*/\n.header {\n	background: [[ColorPalette##PrimaryMid]];\n}\n\n.headerShadow {\n	color: [[ColorPalette##Foreground]];\n}\n\n.headerShadow a {\n	font-weight: normal;\n	color: [[ColorPalette##Foreground]];\n}\n\n.headerForeground {\n	color: [[ColorPalette##Background]];\n}\n\n.headerForeground a {\n	font-weight: normal;\n	color: [[ColorPalette##PrimaryPale]];\n}\n\n/*}}}*/\n/***\n!General tabs /%=================================================%/\n***/\n/*{{{*/\n\n.tabSelected{\n	color: [[ColorPalette##PrimaryDark]];\n	background: [[ColorPalette##TertiaryPale]];\n	border-left: 1px solid [[ColorPalette##TertiaryLight]];\n	border-top: 1px solid [[ColorPalette##TertiaryLight]];\n	border-right: 1px solid [[ColorPalette##TertiaryLight]];\n}\n\n.tabUnselected {\n	color: [[ColorPalette##Background]];\n	background: [[ColorPalette##TertiaryMid]];\n}\n\n.tabContents {\n	color: [[ColorPalette##PrimaryDark]];\n	background: [[ColorPalette##TertiaryPale]];\n	border: 1px solid [[ColorPalette##TertiaryLight]];\n}\n\n.tabContents .button {\n	 border: 0;}\n\n/*}}}*/\n/***\n!Sidebar options /%=================================================%/\n~TiddlyLinks and buttons are treated identically in the sidebar and slider panel\n***/\n/*{{{*/\n#sidebar {\n}\n\n#sidebarOptions input {\n	border: 1px solid [[ColorPalette##PrimaryMid]];\n}\n\n#sidebarOptions .sliderPanel {\n	background: [[ColorPalette##PrimaryPale]];\n}\n\n#sidebarOptions .sliderPanel a {\n	border: none;\n	color: [[ColorPalette##PrimaryMid]];\n}\n\n#sidebarOptions .sliderPanel a:hover {\n	color: [[ColorPalette##Background]];\n	background: [[ColorPalette##PrimaryMid]];\n}\n\n#sidebarOptions .sliderPanel a:active {\n	color: [[ColorPalette##PrimaryMid]];\n	background: [[ColorPalette##Background]];\n}\n/*}}}*/\n/***\n!Message Area /%=================================================%/\n***/\n/*{{{*/\n#messageArea {\n	border: 1px solid [[ColorPalette##SecondaryDark]];\n	background: [[ColorPalette##SecondaryMid]];\n	color: [[ColorPalette##PrimaryDark]];\n}\n\n#messageArea .button {\n	padding: 0.2em 0.2em 0.2em 0.2em;\n	color: [[ColorPalette##PrimaryDark]];\n	background: [[ColorPalette##Background]];\n}\n\n/*}}}*/\n/***\n!Popup /%=================================================%/\n***/\n/*{{{*/\n.popup {\n	background: [[ColorPalette##PrimaryLight]];\n	border: 1px solid [[ColorPalette##PrimaryMid]];\n}\n\n.popup hr {\n	color: [[ColorPalette##PrimaryDark]];\n	background: [[ColorPalette##PrimaryDark]];\n	border-bottom: 1px;\n}\n\n.popup li.disabled {\n	color: [[ColorPalette##PrimaryMid]];\n}\n\n.popup li a, .popup li a:visited {\n	color: [[ColorPalette##TertiaryPale]];\n	border: none;\n}\n\n.popup li a:hover {\n	background: [[ColorPalette##PrimaryDark]];\n	color: [[ColorPalette##Background]];\n	border: none;\n}\n/*}}}*/\n/***\n!Tiddler Display /%=================================================%/\n***/\n/*{{{*/\n.tiddler .defaultCommand {\n font-weight: bold;\n}\n\n.shadow .title {\n	color: [[ColorPalette##TertiaryDark]];\n}\n\n.title {\n	color: [[ColorPalette##SecondaryDark]];\n}\n\n.subtitle {\n	color: [[ColorPalette##TertiaryDark]];\n}\n\n.toolbar {\n	color: [[ColorPalette##PrimaryMid]];\n}\n\n.tagging, .tagged {\n	border: 1px solid [[ColorPalette##TertiaryPale]];\n	background-color: [[ColorPalette##TertiaryPale]];\n}\n\n.selected .tagging, .selected .tagged {\n	background-color: [[ColorPalette##TertiaryLight]];\n	border: 1px solid [[ColorPalette##TertiaryMid]];\n}\n\n.tagging .listTitle, .tagged .listTitle {\n	color: [[ColorPalette##PrimaryDark]];\n}\n\n.tagging .button, .tagged .button {\n		border: none;\n}\n\n.footer {\n	color: [[ColorPalette##TertiaryLight]];\n}\n\n.selected .footer {\n	color: [[ColorPalette##TertiaryMid]];\n}\n\n.sparkline {\n	background: [[ColorPalette##PrimaryPale]];\n	border: 0;\n}\n\n.sparktick {\n	background: [[ColorPalette##PrimaryDark]];\n}\n\n.errorButton {\n	color: #ff0;\n	background: #f00;\n}\n\n.cascade {\n	background: [[ColorPalette##TertiaryPale]];\n	color: [[ColorPalette##TertiaryMid]];\n	border: 1px solid [[ColorPalette##TertiaryMid]];\n}\n\n.imageLink, #displayArea .imageLink {\n	background: transparent;\n}\n\n/*}}}*/\n/***\n''The viewer is where the tiddler content is displayed'' /%------------------------------------------------%/\n***/\n/*{{{*/\n\n.viewer .listTitle {list-style-type: none; margin-left: -2em;}\n\n.viewer .button {\n	border: 1px solid [[ColorPalette##SecondaryMid]];\n}\n\n.viewer blockquote {\n	border-left: 3px solid [[ColorPalette##TertiaryDark]];\n}\n\n.viewer table {\n	border: 2px solid [[ColorPalette##TertiaryDark]];\n}\n\n.viewer th, thead td {\n	background: [[ColorPalette##SecondaryMid]];\n	border: 1px solid [[ColorPalette##TertiaryDark]];\n	color: [[ColorPalette##Background]];\n}\n\n.viewer td, .viewer tr {\n	border: 1px solid [[ColorPalette##TertiaryDark]];\n}\n\n.viewer pre {\n	border: 1px solid [[ColorPalette##SecondaryLight]];\n	background: [[ColorPalette##SecondaryPale]];\n}\n\n.viewer code {\n	color: [[ColorPalette##SecondaryDark]];\n}\n\n.viewer hr {\n	border: 0;\n	border-top: dashed 1px [[ColorPalette##TertiaryDark]];\n	color: [[ColorPalette##TertiaryDark]];\n}\n\n.highlight, .marked {\n	background: [[ColorPalette##SecondaryLight]];\n}\n/*}}}*/\n/***\n''The editor replaces the viewer in the tiddler'' /%------------------------------------------------%/\n***/\n/*{{{*/\n.editor input {\n	border: 1px solid [[ColorPalette##PrimaryMid]];\n}\n\n.editor textarea {\n	border: 1px solid [[ColorPalette##PrimaryMid]];\n	width: 100%;\n}\n\n.editorFooter {\n	color: [[ColorPalette##TertiaryMid]];\n}\n\n/*}}}*/",
