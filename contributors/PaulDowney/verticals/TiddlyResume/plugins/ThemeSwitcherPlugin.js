...
config.macros.selectTheme.onClick = function(ev)
{
	...
	for(var i=0; i<tiddlers.length; i++) {
		...
		var btn = createTiddlyButton(createTiddlyElement(popup,'li',null,classname),name ? name : t,desc ? desc : config.macros.selectTheme.label,config.macros.selectTheme.onClickTheme);
