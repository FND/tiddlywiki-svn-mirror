...
|''~CoreVersion:''|2.4|
!!Documentation
This plugin extends the core RSS saving to include [[W3C GeoRSS|http://en.wikipedia.org/wiki/GeoRSS]] values for tiddlers with ''latitude'' and ''longitude'' [[extended fields|http://www.tiddlywiki.org/wiki/Extended_fields]].  Coordinates are taken to be in the [[WGS|http://en.wikipedia.org/wiki/World_Geodetic_System]] format. For example output, see [[index.xml|http://whatfettle.com/2008/07/GeoRSSPlugin/index.xml]], and the result when passed to[[Google Maps|http://maps.google.com/maps?f=q&source=s_q&hl=en&geocode=&q=http:%2F%2Fwhatfettle.com%2F2008%2F07%2FGeoRSSPlugin%2Findex.xml&ie=UTF8&t=h&z=14]].
...
version.extensions.GeoRSSPlugin = {installed:true};
	...
	if(!config.extensions){
		...
		generateRss: function()
		{
			...
			return s.replace(/">/, '" xmlns:geo="'+me.geo+'">');
		}
	};
