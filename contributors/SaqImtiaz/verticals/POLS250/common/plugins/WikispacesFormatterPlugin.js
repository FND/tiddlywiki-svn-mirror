/***
|''Name:''|WikispacesFormatterPlugin - modified by Saq|
	...
	handler: function(w)
	{
		...
		if(lookaheadMatch && lookaheadMatch.index == w.matchStart) {
			if(lookaheadMatch[1]=='page') {
				...
				invokeMacro(w.output,'list','filter '+'[tag['+tags.toLowerCase()+']]',w,w.tiddler);
			} else if (lookaheadMatch[1]=="component" && lookaheadMatch[2]=="pageList") {
					console.log('listing')
					invokeMacro(w.output,'list','all',w,w.tiddler);
			}
