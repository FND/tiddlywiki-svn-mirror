...
config.macros.importWorkspace.getTiddlersForAllFeeds = function(userCallback)
{
	//console.log('getTiddlersForAllFeeds',arguments)
	var tiddlers = store.getTaggedTiddlers('systemServer');
...
{
	//console.log('getTiddlersForFeed',arguments)
...
{
	//console.log('getTiddlers',arguments)
	var fields = {};
...
{
	//console.log("config.macros.importWorkspace.getTiddlersForContext",context);
	if(context) {
...
//#console.log("config.macros.importWorkspace.getTiddlerListCallback:"+context.status);
	...
	//	console.log(length)
	//	console.log(context.adaptor.getTiddlerLength)
	//	console.log(context)
	//	console.log(context.userCallback.toString())
		if(context.adaptor.getTiddlerLength == 0 && context.userCallback)
...
{
	//console.log("config.macros.importWorkspace.getTiddlerCallback:",arguments);
