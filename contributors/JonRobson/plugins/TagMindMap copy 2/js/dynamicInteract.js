...
/*Generic  properties */
this.canvasID = divID + "_canvas"; //the canvas object ID
this.labelContainer = divID + "_label_container";
...
Tagmindmap.prototype = {
	...
	_init_defaults: function(){		
		...
		this.editNodeURL = "edit.html";	
		this.userCanDeleteNodes = false;
		/*individual Node properties and toolbar */
		this.useDHTML = true;
		this.nodeToolBar = false;
