		...
		wrapper.onmousedown = function (event){		
			...
			if(tiddlytagmindmapobject){
				...
				if (event.pageX || event.pageY) 	{
					...
					myX = event.clientX + document.body.scrollLeft+ document.documentElement.scrollLeft;
					myY = event.clientY + document.body.scrollTop+ document.documentElement.scrollTop;
