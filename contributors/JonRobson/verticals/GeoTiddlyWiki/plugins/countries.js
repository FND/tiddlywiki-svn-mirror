config.macros.exposeCountries={};

config.macros.exposeCountries.handler = function(place,macroName,params,wikifier,paramString,tiddler) {
	var txt ="";
...
console.log(countryCodesMap);
var i;
//var alpha = '';
var options = [];
var first;
for(i in countryCodesMap){
	if(!first) first = i;
	/*if(i.charAt(0) != alpha) {
		var c = i.charAt(0);
		if(c != 'Å') {
...
onchange = function(change){
	...
	story.displayTiddler(null,country);	
}; 
createTiddlyDropDown(place,onchange,options,first);
//wikify(txt,place);
