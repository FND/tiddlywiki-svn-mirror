...
make_tw {
  ...
  temp = get_tiddler("DefaultTiddlers").text
  get_tiddler("DefaultTiddlers").text += " [[Welcome to your tiddlyspot.com site!]]"
  store_to_divs          "upload/mGTD2.tiddler"
  get_tiddler("DefaultTiddlers").text = temp
