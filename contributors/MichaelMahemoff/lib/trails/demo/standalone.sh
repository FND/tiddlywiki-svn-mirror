...
files="index.html static/js/jquery-1.3.2.js static/js/jquery.modal.js static/js/jquery.iframe.js static/js/trailPlayer.js static/css/trails.css static/images/*"
