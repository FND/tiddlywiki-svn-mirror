...
if($tiddlyCfg['use_mod_rewrite'] ==1)
	$tiddler['body'] = "<link rel='alternate' type='application/rss+xml' title='RSS' href='".getURL()."?workspace='".$tiddlyCfg['workspace_name']."'/>";
else
	$tiddler['body'] = "<link rel='alternate' type='application/rss+xml' title='RSS' href='".getURL().$tiddlyCfg['workspace_name']."/index.xml'/>";
