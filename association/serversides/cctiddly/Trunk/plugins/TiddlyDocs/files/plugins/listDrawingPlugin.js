config.macros.listDrawingPlugin = {};
config.macros.listDrawingPlugin.handler = function(place,macroName,params)
{
	var context = {};
	context.callback = function() {
		config.macros.listDrawingPlugin.display(place, params);
	};
	...
	for(var t=tiddlers.length-1; t>=last; t--) {
		if(tiddlers[t].isTagged("Drawing")){
...
config.macros.listDrawingPlugin.display = function (place, params)
{
