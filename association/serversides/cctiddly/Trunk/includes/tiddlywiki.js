...
merge(config.macros.importTiddlers,{
	...
	step1Title: "Step 1: Locate the server",
	step1Html: "<table> <tr><th align='right'>Server Type</th><td> <select name='selTypes'><option value=''>Choose...</option></select><input type='file' size=50 name='txtBrowse' style='display:none'></td></tr><tr><th align='right'>Enter the URL</th><td> <input type='text' size=50 name='txtPath'></td></tr><tr><th align='right'>or select a feed</th><td><select name='selFeeds'><option value=''>Choose...</option></select></td></tr></table>",
	openLabel: "open",
