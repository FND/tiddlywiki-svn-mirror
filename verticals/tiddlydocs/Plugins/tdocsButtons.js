...
config.macros.tdButtons.handler=function(place,macroName,params,wikifier,paramString,tiddler){
	...
	var btn = createTiddlyButton(buttonHolder, "preview", "preview current document", previewClick, null, null, null, null, "/static/mypage_images/icon_preview.jpg");
	var btn = createTiddlyButton(buttonHolder, "new", "New Section", config.macros.newTiddler.onClickNewTiddler, null, null, null, null, "/static/mypage_images/icon_new.jpg");
