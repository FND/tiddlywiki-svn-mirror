...
config.macros.docPrint.handler =  function(place, macroName, params, wikifier, paramString, tiddler) {		
	createTiddlyButton(place, "print", "Download a printable PDF version of the document.", config.macros.docPrint.onClickPrint, null, null, null, null, "/doccollab/static/mydocs_images/icon_print.jpg");
}
