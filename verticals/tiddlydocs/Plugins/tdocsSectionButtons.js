...
config.macros.docSectionButtons.handler = function(place,macroName,params,wikifier,paramString,tiddler) {
	var img = createTiddlyElement(place, 'img', '', '', '', {'height':'12px'});
	...
	var img = createTiddlyElement(place, 'img', '', '', '', {'height':'15px'});
	img.src = 'http://www.btwholesale.com/container/static/wa/jarrita/skins/wholesale/images/icons/close_normal.png';
